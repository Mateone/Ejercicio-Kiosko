...
namespace Expert_SRP
{
    public class Kiosco
    {
        ...
        //el cambio a otra moneda tendría que cambiar. Mientras que la responsabilidad de "PuedeComprar" debería ser de la clase alfajor
        //porque es el experto en los datos, por lo tanto está fallando al expert.
